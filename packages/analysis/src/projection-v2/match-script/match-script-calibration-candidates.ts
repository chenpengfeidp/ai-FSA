...
/**
 * R1B Candidate A — frozen pre-calibration Match Script tables (matchScript.v1).
 * Kept immutable so baseline vs candidate replay remains comparable.
 */
export const MATCH_SCRIPT_BASELINE_V1_PARAMETER_SET = {
  policyVersion: "matchScript.v1",
  calibrationLabel: "r1b.candidate.a.baseline",
  temperature: 0.85,
  minScriptWeight: 0.1,
  minActiveScripts: 2,
  catalog: [
...
/**
 * R1B Candidate B — more conservative Control activation + stronger Open affinity.
 * No side-aware defense gate yet.
 */
export const MATCH_SCRIPT_R1B_CANDIDATE_B_PARAMETER_SET = {
  policyVersion: "matchScript.v1",
  calibrationLabel: "r1b.candidate.b.controlOpen",
  temperature: 0.85,
  minScriptWeight: 0.1,
  minActiveScripts: 2,
  catalog: [
      ...
      asymmetricBonuses: [
        {
          ...
          minimumRatingGap: 8,
          weight: 0.2,
          reason: "Home attack rating exceeds away attack rating by a material gap.",
        },
      ],
    },
    {
      ...
      asymmetricBonuses: [
        {
          ...
          minimumRatingGap: 8,
          weight: 0.2,
          reason: "Away attack rating exceeds home attack rating by a material gap.",
        },
      ],
    },
    {
...
/**
 * R1B Candidate C — Candidate B + side-aware Control gate + bilateral Open bonus
 * + milder underdog λ suppression on Control scripts.
 */
export const MATCH_SCRIPT_R1B_CANDIDATE_C_PARAMETER_SET = {
  policyVersion: "matchScript.v1",
  ...
  catalog: [
      ...
      dimensionBonuses: [
        {
          ...
          weight: 0.3,
          reason:
            "Control state at high supports home territorial control (R1B gate).",
        },
        {
          dimensionId: "attackState",
          minimumLevel: "medium",
      ...
      asymmetricBonuses: [
        {
          side: "home",
          minimumRatingGap: 10,
          minimumAttackVsOpponentDefenseGap: 5,
          weight: 0.18,
          reason:
            "Home attack exceeds away attack and away defense by material gaps.",
        },
      ],
    },
    {
      ...
      dimensionBonuses: [
        {
          ...
          weight: 0.3,
          reason:
            "Control state at high supports away territorial control (R1B gate).",
        },
        {
          dimensionId: "attackState",
          minimumLevel: "medium",
      ...
      asymmetricBonuses: [
        {
          ...
          weight: 0.18,
          reason:
            "Away attack exceeds home attack and home defense by material gaps.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      compositeTagBonuses: [],
      asymmetricBonuses: [],
      bilateralAttackBonuses: [
        {
          minimumEachAttackRating: 55,
          weight: 0.28,
          reason:
            "Both sides carry material attack ratings — open scoring exchange is plausible.",
        },
      ],
      maxDimensionLevel: {
        dimensionId: "defenseState",
