...
export const zh = {
  ...
  report: {
    ...
    calibration: "预测校准",
    calibrationHint:
      "仅依据评估历史（A1.5）计算的全量历史可靠性度量；只做展示，不会调整任何预测",
    calibrationUnavailable: "暂无评估历史，无法计算校准指标",
    calibrationSampleSize: "样本量",
    calibrationQualified: "样本充足",
    calibrationUnqualified: "样本不足（仅供参考）",
    calibrationMinimumSample: (min: number): string => `最低合格样本量：${min}`,
    calibrationProvenance: "数据来源",
    calibrationSourceRecordCount: "来源记录数",
    calibrationDateRange: "覆盖日期范围",
    calibrationLimitations: "局限说明",
    calibrationConfidenceBucketAccuracy: "置信区间准确率",
    calibrationConfidenceDistribution: "置信分布",
    calibrationReliabilityTable: "可靠性表（预测概率 vs 实际频率）",
    calibrationExpectedCalibrationError: "校准误差（ECE）",
    calibrationBrierScore: "Brier 分数",
    calibrationOutcomeCalibration: "胜/平/负校准",
    calibrationGoalRangeCalibration: "进球区间校准",
    calibrationBand: "置信档",
    calibrationOutcome: "结果",
    calibrationOutcomeHome: "主胜",
    calibrationOutcomeDraw: "平局",
    calibrationOutcomeAway: "客胜",
    calibrationBucket: "概率区间",
    calibrationGoalRangeLabel: {
      range01: "0-1 球",
      range23: "2-3 球",
      range4Plus: "4+ 球",
    },
    calibrationAccuracy: "准确率",
    calibrationHits: "命中数",
    calibrationShare: "占比",
    calibrationMeanPredicted: "平均预测概率",
    calibrationObservedFrequency: "实际频率",
    calibrationInsufficientBadge: "样本不足",
    validation: "足球智能验证",
    validationHint:
    ...
    matchScriptsUnavailable: "当前分析未启用 Match Script 元数据",
    footballState: "足球状态",
    footballStateHint:
      "从现有特征聚合的确定性足球状态层；Projection 只读取此层，不直接读取分散特征",
    footballStatePipeline: "证据 → 特征 → 足球状态 → 投影",
    footballStateUnavailable: "当前分析未启用 Football State",
    ...
    matchScriptProvenance: (policy: string, checksum: string): string =>
      `溯源：${policy} · checksum ${checksum}`,
    multiScriptProjection: "统一概率矩阵",
    multiScriptProjectionHint:
      "每个激活剧本生成独立比分矩阵；Match Script 权重合并为统一矩阵，所有预测均从该矩阵边际导出",
    multiScriptPipeline: "足球状态 → 比赛剧本 → 分剧本矩阵 → 统一矩阵 → 衍生预测",
    multiScriptProjectionUnavailable: "当前分析未启用统一概率矩阵",
    fixtureResolution: "赛程解析",
    fixtureResolutionHint:
      "将请求的队名解析为 Match Center 赛程中的真实 fixture，再进入现有 AnalyzeMatch 管道",
    fixtureRequested: "请求对阵",
    fixtureResolved: "解析对阵",
    fixtureMatchId: "matchId",
    fixtureKickoff: "开球时间",
    fixtureProvenance: "赛程来源",
    fixtureSwapped: "主客与请求顺序相反",
    projectionPolicyPin: "投影策略",
    projectionV2Active: "Projection V2 生产路径",
    multiScriptPerScriptMatrix: "分剧本矩阵预测",
    multiScriptMergedFinal: "统一矩阵摘要",
    multiScriptDerivedPredictions: "矩阵衍生预测",
    multiScriptDerivationNotes: "推导说明",
    multiScriptBtts: "双方进球",
    multiScriptOverUnder: "大小球 2.5",
    ...
    validationLimitations: "局限说明",
    validationProfile: "特征配置画像",
    validationProfileLabel: {
      baseline: "基线",
      club_intelligence: "俱乐部智能",
      club_player: "俱乐部 + 球员",
      club_player_xg: "俱乐部 + 球员 + 预期进球",
      full_football_intelligence: "完整足球智能",
    },
    validationSampleSize: "样本量",
    validationWinnerAccuracy: "胜者准确率",
    validationDrawAccuracy: "平局准确率",
    validationScoreAccuracy: "比分准确率",
    validationGoalRangeAccuracy: "进球区间准确率",
    validationCoverage: "特征覆盖率",
    validationPaperReturn: "纸面单位收益（仅供研究展示）",
    validationEce: "校准误差（ECE）",
    validationBrier: "Brier 分数",
    validationInsufficientBadge: "样本不足",
    contribution: "足球智能贡献分析",
    contributionHint:
      "按足球智能领域对已封存的历史预测分组测量；仅做展示，不代表因果关系，也不对领域排名",
    contributionUnavailable: "暂无评估历史，无法计算贡献指标",
    contributionTotalSampleSize: "历史预测总量",
    contributionMinimumSample: (min: number): string => `最低合格样本量：${min}`,
    contributionLimitations: "局限说明",
    contributionDomain: "智能领域",
    contributionDomainLabel: {
      venue_intelligence: "场地智能",
      availability_intelligence: "可用性智能",
    ...
    contributionCoverage: "领域覆盖率",
    contributionWinnerAccuracy: "胜者准确率",
    contributionDrawAccuracy: "平局准确率",
    contributionScoreAccuracy: "比分准确率",
    contributionGoalRangeAccuracy: "进球区间准确率",
    contributionEce: "校准误差（ECE）",
    contributionBrier: "Brier 分数",
    contributionPaperReturn: "纸面单位收益（仅供研究展示）",
    contributionInsufficientBadge: "样本不足",
    projectionReplay: "投影回放验证",
    projectionReplayHint:
      "基于封存评估历史，独立回放 Projection V1 与 V2 并比较测量指标；不会改写预测或重新拉取数据",
    projectionReplayUnavailable: "暂无评估历史，无法计算投影回放验证",
    projectionReplaySampleSize: "样本量",
    projectionReplayV2Coverage: "V2 回放覆盖率",
    projectionReplayVersionComparison: "V1 vs V2 对比",
    projectionReplayImprovement: "V2 相对 V1",
    projectionReplayMetric: "指标",
    projectionReplayWinner: "胜者",
    projectionReplayDraw: "平局",
    projectionReplayScore: "精确比分",
    projectionReplayGoalRange: "进球区间",
    projectionReplayBtts: "双方进球",
    projectionReplayOverUnder: "大小球 2.5",
    projectionReplayScriptStats: "比赛剧本统计",
    projectionReplayScript: "剧本",
    projectionReplayActivationFrequency: "激活频率",
    projectionReplayAverageWeight: "平均权重",
    projectionReplayAverageConfidence: "平均置信度",
    projectionReplayFootballStateStats: "足球状态维度统计",
    projectionReplayFootballStateDimension: "维度",
    projectionReplayFootballStateLevel: "水平",
    projectionReplayLimitations: "局限说明",
    projectionReplayInsufficientBadge: "样本不足",
    projectionDiagnostics: "投影诊断",
    projectionDiagnosticsHint:
      "基于封存评估历史回放结果的确定性根因诊断；不会改写预测、不会调参、不会自动优化",
    projectionDiagnosticsUnavailable: "暂无评估历史，无法计算投影诊断",
    projectionDiagnosticsSampleSize: "样本量",
    projectionDiagnosticsTopFailures: "主要失败原因",
    projectionDiagnosticsWorstScripts: "表现较差剧本",
    projectionDiagnosticsBestScripts: "表现较好剧本",
    projectionDiagnosticsFootballState: "足球状态有效性",
    projectionDiagnosticsDimension: "维度",
    projectionDiagnosticsLevel: "水平",
    projectionDiagnosticsAccuracy: "准确率",
    projectionDiagnosticsFalsePositive: "假阳性",
    projectionDiagnosticsFalseNegative: "假阴性",
    projectionDiagnosticsRuleConflicts: "规则冲突对",
    projectionDiagnosticsRuleSaturation: (
      averagePass: string,
      saturated: number,
    ): string => `规则饱和：平均 PASS ${averagePass} · 饱和场次 ${saturated}`,
    projectionDiagnosticsConfidence: "置信度分析",
    projectionDiagnosticsHighConfidenceWrong: "高置信但错误",
    projectionDiagnosticsLowConfidenceCorrect: "低置信但正确",
    projectionDiagnosticsBand: "置信档",
    projectionDiagnosticsIncorrect: "错误数",
    projectionDiagnosticsLimitations: "局限说明",
    projectionDiagnosticsInsufficientBadge: "样本不足",
    projectionParameters: "投影参数",
    projectionParametersHint:
      "只读展示版本化投影参数制品：活跃版本、参数组与来源校验。不调参、不训练。",
    projectionParametersUnavailable: "暂无投影参数目录",
    projectionParametersActiveVersion: "活跃参数版本",
    projectionParametersModelVersion: "目录模型",
    projectionParametersVersion: "版本标签",
    projectionParametersArtifactId: "制品 ID",
    projectionParametersGroups: "参数组",
    projectionParametersChecksum: "校验和",
    projectionParametersFlags: "标记",
    projectionParametersActiveBadge: "活跃",
    projectionParametersUsedBadge: "本场使用",
    projectionParametersLimitations: "局限说明",
    reasoning: "推理",
    ...
    players: "球员情报证据",
    playersHint:
      "原始 PLAYER Evidence：阵容身份 + Provider 提供时的赛季统计/可用性/比赛名单状态（不做球员质量解读或评分，不进入 Rule/Projection）",
    playersHome: "主队球员",
    playersAway: "客队球员",
    playerNumber: (value: number): string => `号码 ${String(value)}`,
    playerId: (id: string): string => `球员 ID · ${id}`,
    playerAge: (value: number): string => `${String(value)} 岁`,
    playerCaptain: "队长",
    playerAvailabilityInjury: "伤病缺席",
    playerAvailabilitySuspension: "禁赛缺席",
    playerSquadStatusStarting: "首发",
    playerSquadStatusBench: "替补席",
    playerStatAppearances: "出场次数",
    playerStatStarts: "首发次数",
    playerStatMinutesPlayed: "出场时间（分钟）",
    playerStatRating: "评分",
    playerStatGoals: "进球",
    playerStatAssists: "助攻",
    playerStatYellowCards: "黄牌",
    playerStatRedCards: "红牌",
    playerStatSaves: "扑救",
    playerStatGoalsConceded: "失球",
    playerStatsNone: "暂无该球员的赛季统计证据。",
    noPlayers: "暂无球员证据",
    lineups: "确认阵容",
    ...
    clubIntelligence: "俱乐部情报",
    clubIntelligenceHint:
      "原始 CLUB_INTELLIGENCE Evidence（积分榜 / 主客场战绩 / 近况 / 教练等 Provider 事实）。衍生足球情报见特征重要性；本区不做解读或评分",
    noClubIntelligence: "暂无俱乐部情报证据",
    clubHome: "主队俱乐部",
    clubAway: "客队俱乐部",
    clubNoMetrics: "俱乐部情报记录存在，但无可展示指标。",
    clubWindowSeason: "赛季",
    clubWindowCurrent: "当前",
    clubMetricLeagueRank: "联赛排名",
    clubMetricLeaguePoints: "积分",
    clubMetricGoalDifference: "净胜球",
    clubMetricGoalsScored: "进球",
    clubMetricGoalsConceded: "失球",
    clubMetricWins: "胜",
    clubMetricDraws: "平",
    clubMetricLosses: "负",
    clubMetricPlayed: "场次",
    clubMetricHomeRecord: "主场战绩（胜/平/负）",
    clubMetricAwayRecord: "客场战绩（胜/平/负）",
    clubMetricCurrentForm: "近况（积分榜）",
    clubMetricPromotionRelegation: "升级/降级区说明",
    clubMetricManagerName: "教练",
    clubMetricManagerStartDate: "上任日期",
    clubMetricManagerTenureDays: "执教天数",
    managerIntelligence: "教练情报",
    managerIntelligenceHint:
      "原始 MANAGER_INTELLIGENCE Evidence（教练身份 / 上任日期 / 执教天数 / 履历等 Provider 事实）。不评价教练水平或战术能力",
    noManagerIntelligence: "暂无教练情报证据",
    managerHome: "主队",
    managerAway: "客队",
    managerNoMetrics: "教练情报记录存在，但无可展示指标。",
    managerMatchConfirmed: "已确认当场执教",
    managerMatchUnconfirmed: "未经阵容确认",
    managerMetricId: "教练 ID",
    managerMetricNationality: "国籍",
    managerMetricAge: "年龄",
    managerMetricAppointmentDate: "上任日期",
    managerMetricTenureDays: "执教天数",
    managerMetricInterimStatus: "临时教练状态",
    managerMetricPreviousClubs: "此前执教俱乐部",
    managerInterimYes: "是",
    managerInterimNo: "否",
    xgHome: "主队 xG",
    xgAway: "客队 xG",
