...
export class AnalysisReportDto {
  ...
  @ApiPropertyOptional({
    description:
      "P2H Projection Replay Validation — population-level V1 vs V2 replay comparison over sealed Evaluation History. Display-only; never mutates History or Prediction.",
    type: "object",
    additionalProperties: true,
  })
  declare readonly projectionReplay?: Readonly<Record<string, unknown>>;
  ...
  @ApiPropertyOptional({
    description:
      "P2J Projection Parameter Artifact catalog — versioned parameter provenance (active version, groups, checksum). Display-only; never tunes parameters.",
    type: "object",
    additionalProperties: true,
  })
  declare readonly projectionParameters?: Readonly<Record<string, unknown>>;
