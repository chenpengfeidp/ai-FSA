...
export function buildMvpIntelligenceNarrative(
  ...
  const strengthBody = [
    ...
    `ManagerIntelligenceFeatures (derived from MANAGER_INTELLIGENCE Evidence): managerTenureStability home=${numericFeature(analysis.features, "managerTenureStabilityHome") ?? "n/a"} away=${numericFeature(analysis.features, "managerTenureStabilityAway") ?? "n/a"}; managerExperience home=${numericFeature(analysis.features, "managerExperienceHome") ?? "n/a"} away=${numericFeature(analysis.features, "managerExperienceAway") ?? "n/a"}; managerContinuity home=${numericFeature(analysis.features, "managerContinuityHome") ?? "n/a"} away=${numericFeature(analysis.features, "managerContinuityAway") ?? "n/a"}; managerChangeRisk home=${numericFeature(analysis.features, "managerChangeRiskHome") ?? "n/a"} away=${numericFeature(analysis.features, "managerChangeRiskAway") ?? "n/a"}; managerCareerStability home=${numericFeature(analysis.features, "managerCareerStabilityHome") ?? "n/a"} away=${numericFeature(analysis.features, "managerCareerStabilityAway") ?? "n/a"}.`,
  ].join(" ");
