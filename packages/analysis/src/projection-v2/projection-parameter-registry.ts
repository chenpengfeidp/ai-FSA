...
import { PROJECTION_CALIBRATION_CANDIDATE1_ARTIFACT } from "./projection-calibration-candidate1.js";
import {
...
export function getProjectionParameterArtifactByVersionLabel(
  ...
  if (
    ...
    normalized !== PROJECTION_PARAMETER_VERSION_CALIBRATION_CANDIDATE1
  ) {
    return undefined;
  }
