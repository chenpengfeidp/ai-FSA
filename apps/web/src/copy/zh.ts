...
export const zh = {
  ...
  report: {
    ...
    evaluationHistoryHint: "只读历史记录，供后续校准与统计使用；不会改写当前预测",
    evaluationHistoryUnavailable: "暂无本场评估历史",
    historyMatch: "对阵",
    historySeason: "赛季",
    historyDate: "比赛日期",
    historyCompetition: "赛事",
    historyPins: "版本钉",
    historyConfidence: "置信快照",
    historyRecordedAt: "入库时间",
    reasoning: "推理",
