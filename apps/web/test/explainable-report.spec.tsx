...
describe("ExplainableMatchReport", () => {
  it("renders stacked AI workspace sections from analysis output", () => {
    ...
    expect(screen.getByText(zh.report.projectionDiagnostics)).toBeInTheDocument();
    expect(
      screen.getByText(zh.report.projectionDiagnosticsUnavailable),
    ).toBeInTheDocument();
    expect(screen.getByText(zh.report.projectionParameters)).toBeInTheDocument();
    expect(
      screen.getByText(zh.report.projectionParametersUnavailable),
    ).toBeInTheDocument();
  });
