...
27. **P2K-G-RECOVERY Projection V2 Bootstrap** — 已完成（`docs/sprints/P2K/P2K_G_RECOVERY_PROJECTION_V2_VALIDATION_DATA_BOOTSTRAP_COMPLETION_REPORT.md`；`match-p2kg-recovery-v2-*` ×6；parameter provenance 完整；offlineReplayExecutable=6；ready for new cohort；未自动 E/F/G）  
28. **Football Intelligence v3 Knowledge Model Design**（设计评审，非编码冲刺）— 已完成（`docs/architecture/FOOTBALL_INTELLIGENCE_V3_KNOWLEDGE_MODEL_DESIGN.md`）  
29. **Candidate C promotion gate / P2K-H+** — 仅在人工治理授权后  
30. **L2A Squad Intelligence Evidence** — 其后候选  
31. 其后按 DA Waves 2–6 / 可选 Provider Gate → v1.0  

历史已交付（勿重复开工）：F1.1* · F1.2* · F1.3* · I1* · I2* · Freeze Review v0.3 · P0 · DA · L1A · L1B · P1A · P1B · A2 · V1A · O1 · M1A · M1B · R1A · R1B · V3-KM（设计） · P2A–P2J · P2K-A/B · P2K-C · P2K-D · P2K-E · P2K-F · P2K-G · Validation Data Bootstrap · P2K-E Validation Seal · P2K-F Validation（fail closed） · P2K-G-RECOVERY V2 Bootstrap  
